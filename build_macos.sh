...
main () {
    ...
    clang -dynamiclib -o supreme-broccoli.dylib code/SB_Application.cpp -O3 --debug -std=c++98
    clang ${FRAMEWORKS} macos/SB_Main.mm -o supreme-broccoli -O3 --debug -std=c++98
